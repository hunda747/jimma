  ...
  const handleDiactivation = async () => {
    ...
    if (empInfo.Status === "Active") {
      ...
      const response = await axios.post(
        `http://${localhost}/api/deactivation`,
        {
          email: email,
        }
      );
      ...
      <div>
        ...
        >
          <DialogTitle id="alert-dialog-slide-title">
            {user_name === null ? "Unavailable" : user_name}
          </DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
              <p className="dialog_email">
                {" "}
                <b>Phone :</b> {phone}
              </p>
              <p className="dialog_access_key">
                <b>User Name :</b> {user_name}
              </p>
              <p className="dialog_date">
                <b>SignUp Date :</b> {date}
              </p>
              <p className="dialog_status">
                {" "}
                <b>Status : </b> {status}
              </p>
            </DialogContentText>
