...
export default function Register() {
  ...
  const onFinish = async () => {
    ...
    try {
      if (
        registerInfo.fname === "" ||
        registerInfo.lname === "" ||
        registerInfo.phoneNo === "" ||
        registerInfo.email === "" ||
        registerInfo.password === "" ||
        registerInfo.conformPassword === ""
      ) {
        ...
        registerInfo.phoneNo.length !== 10
      ) {
      ...
      // }
        ...
        const res = await axios.post(apiURL + "/api/user/addUserByPhone", {
  ...
  const loginHandler = async () => {
    ...
    try {
      let response;
      response = await axios.post(heroku + "/api/getUser", {
              ...
              <div className="form-container sign-up-container">
                <Form autoComplete="off">
                  ...
                  <p
                    ...
                    className={
                      signUpErr
                        ? "signUpErrMsg erroMessage"
                        : "signUpoffscreen erroMessage"
                    }
                    aria-live="assertive"
                  >
                    {signUpErr}
                  ...
                  <p>
                    ...
                    <span onClick={signUpButtons} className="btnLink">
                      sign in
                    </span>
                  </p>
                </Form>
