                  ...
                  >
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          setRegVal({ ...regVal, userName: e.target.value })
                        }
                      />
                    </Form.Item>
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          setRegVal({ ...regVal, fname: e.target.value })
                        }
                      />
                    </Form.Item>
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          setRegVal({ ...regVal, lname: e.target.value })
                        }
                      />
                    </Form.Item>
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          setRegVal({ ...regVal, phone: e.target.value })
                        }
                      />
                    </Form.Item>
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          setRegVal({ ...regVal, password: e.target.value })
                        }
                      />
                    </Form.Item>
                    ...
                    <Form.Item
                      ...
                      rules={[
                        { required: true, message: "conifrm your password" },
                      ]}
                    >
                      <Input
                        type="password"
                    ...
                    <Form.Item name="signUp">
                      <Button className="al_login_btn" htmlType="submit">
                        SignUp
                      </Button>
                    </Form.Item>
                  </Form>
