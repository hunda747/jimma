      ...
      <div className="aboutpageContainer">
        <div className="aboutPage">
          <div className="aboutInfo">
            <h1>About Us</h1>
            <p>
              April seriously wondered about her sleeping partner choices. She
            ...
            <p>
              ...
              physical pain while the other would likely end up with everyone in
              jail. In Sam's mind, there was only one thing to do. He threw
              everyone else under the bus and he secretly sprinted away leaving
              the others to take the fall without him.
            </p>
          </div>
          ...
          <div className="visitLocations">
            ...
            <div className="visitSlideShowContainer">
              <div className="visitSlideShow1">
                <div>
                  <img
                    src="https://questethiopiatours.com/wp-content/uploads/Harar-Quest-Ethiopia-Tours.jpg.webp"
                    height="100%"
                    width="100%"
                    alt=""
                  />
                ...
                <div>
                  <img
                    src="https://questethiopiatours.com/wp-content/uploads/Hawassa-Quest-Ethiopia-Tours1.jpg.webp"
                    height="100%"
                    width="100%"
                    alt=""
                  />
                ...
                <div>
                  <img
                    src="https://questethiopiatours.com/wp-content/uploads/Jimma-Quest-Ethiopia-Tours.jpg.webp"
                    height="100%"
                    width="100%"
                    alt=""
                  />
                ...
                <div>
                  <img
                    src="https://tse3.mm.bing.net/th?id=OIP.p9Qo0rY7wuQjwjogbSMYfwHaF8&pid=Api&P=0"
                    height="100%"
                    width="100%"
                    alt=""
                  />
